...
import com.ischano.tmall.dao.ProductImageDAO;
...
public class ProductImageService {
    ...
    public List<ProductImage> listSingleProductImages(Product product) {
        return productImageDAO.findByProductAndTypeOrderById(product, type_single);
    }

    public List<ProductImage> listDetailProductImages(Product product) {
        return productImageDAO.findByProductAndTypeOrderById(product, type_detail);
    }
